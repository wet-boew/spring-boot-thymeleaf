...
/**
 * The Class SectionMenu contains information required to build the WET4 side menu.
 * 
 * @author Frank Giusto
 */
public class SectionMenu implements Serializable {
     ...
     * Sets the menu links.
     *
     * @param menuLinks the new menu links
     */
     ...
     *
     * @param sectionNameEn the new section name en
     */
     ...
     *
     * @param sectionNameFr the new section name fr
     */
