 ...
 *
 * To override any of these settings, you have two choices. 1) create a folder
 * under src/main/resources in your application and copy the cdn.properties file
 * from this project there. These will now be your application defaults. 2)
 * create a properties file in your template/view directory. For example, if you
 * have a templates/booking folder containing bookingForm.html which is your
 * thymeleaf page, create a properties file with the same name. ie.
 * bookingForm.properties. Simply add the properties from the original
 * cnd.properties file you wish to override.
 *
...
public class WETSettings {
	...
	/**
	 * @param wettemplateTheme
	 *            the wettemplateTheme to set
	 */
	...
	/**
	 * @param wettemplateVersion
	 *            the wettemplateVersion to set
	 */
	 ...
	 *
	 * @param showPreContent
	 *            the new show pre content
	 */
	 ...
	 *
	 * @param showPostContent
	 *            the new show post content
	 */
	 ...
	 *
	 * @param sessionInactivity
	 *            the new session inactivity
	 */
	 ...
	 *
	 * @param sessionReactionTime
	 *            the new session reaction time
	 */
	 ...
	 *
	 * @param refreshCallbackUrl
	 *            the new refresh callback url
	 */
	 ...
	 *
	 * @param refreshOnClick
	 *            the new refresh on click
	 */
	 ...
	 *
	 * @param leavingSecureSiteWarningEnabled
	 *            the new leaving secure site warning enabled
	 */
	 ...
	 *
	 * @param leavingSecureSiteWarningRedirectUrl
	 *            the new leaving secure site warning redirect url
	 */
	 ...
	 *
	 * @param leavingSecureSiteWarningExcludedDomains
	 *            the new leaving secure site warning excluded domains
	 */
	 ...
	 *
	 * @param exitTransactionLinkUrl
	 *            the new exit transaction link url
	 */
	 ...
	 *
	 * @param contactLinkEnglishUrl
	 *            the new contact link english url
	 */
	 ...
	 *
	 * @param contactLinkFrenchUrl
	 *            the new contact link french url
	 */
	 ...
	 *
	 * @param termsLinkEnglishUrl
	 *            the new terms link english url
	 */
	 ...
	 *
	 * @param termsLinkFrenchUrl
	 *            the new terms link french url
	 */
	 ...
	 *
	 * @param privacyLinkEnglishUrl
	 *            the new privacy link english url
	 */
	 ...
	 *
	 * @param privacyLinkFrenchUrl
	 *            the new privacy link french url
	 */
