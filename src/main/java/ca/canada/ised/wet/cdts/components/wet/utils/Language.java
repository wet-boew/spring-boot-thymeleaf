...
/**
 * The <code>Language</code> class represents all languages currently supported by Strategis. It uses the ISO code
 ...
 * </ul>
 *
 * Support for Spanish uses only the <code>spa</code> value. The <code>esl</code> is not supported by this class
 *
...
public final class Language {
     ...
     * 
     * @param locale <code>Locale</code> for which we want the language.
     * @return the 3-character ISO code of the language for the specified locale.
     */
     ...
     * 
     * @param lang the 3-character ISO code of the language to check.
    ...
    /**
     * <code>isValidLang</code> checks whether the passed paramter represents a valid Strategis supported
     * <code>Language</code>.
     * 
     * @param lang <code>Language</code> to check.
     * @return boolean <code>true</code> if language is supported, <code>false</code> otherwise.
     */
    ...
    /**
     * <code>isValidLocale</code> checks whether the passed paramter represents a valid Strategis supported
     * <code>Locale</code>.
     * 
     * @param locale the <code>Locale</code> to check.
     * @return boolean <code>true</code> if locale is supported, <code>false</code> otherwise.
     */
