...
/**
 * The Class ExitScript contains information required by the WET4 api that
 * monitors when a user requests to leave the secure application.
 */
public class ExitScript implements Serializable {
	 ...
	 *
	 * @param exitScriptEnabled
	 *            the new exit script enabled
	 */
	 ...
	 *
	 * @param exitExcludedDomains
	 *            the new exit excluded domains
	 */
